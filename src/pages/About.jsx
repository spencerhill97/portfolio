    ...
    <section ref={ref} id="about" className="about wrapper">
      ...
      <article className="rundown container">
        ...
        <p>
          ...
          developed a strong passion for creating engaging user interfaces. I'm
          excited to continue this endless learning journey and see how much I
          can improve as a developer!
        </p>
      </article>
      <SkillsContainer />
      <Interests />
